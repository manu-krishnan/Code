...
#>
#WHAT I ACTUALLY USED IS AT THE VERY END.

$listpath = get-content C:\Users\eusubmatt\Documents\shortlist.txt 
    $list = $listpath
# ex: a-test -computername $list 
function a-test {
        param(
...
#a different iteration and attempt. 
function Get-McAfee {
        param(
            $computername =$env:computername
             )
...
#then one at a time I used Compare-Object, then then copy/pasted to one excel file the info I needed.
